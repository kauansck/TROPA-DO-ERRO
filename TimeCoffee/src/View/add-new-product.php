...
<html lang="pt-BR">
  ...
  <head>
        ...
        <title>Adicionando ao catálogo</title>
  </head>
  ...
  <body>
    ...
    <main id="mainMarg">
      <h3 class="text-center text-white">Adicionar produto ao catálogo</h3>
      <div id="cardForm" class="d-flex m-5 justify-content-center align-items-center cardBG w-auto">      
        
        <form action="../Controller/Coffee.php?operation=insert" method="post" class="w-25 p-4 my-5 rounded-lg bg-white">
        <a href="#" style="color: #252525;" class="alert-link hoverCoffee" onclick="history.back()"><i class="fa-solid fa-arrow-left fa-xl "></i></a>
          <input type="text" id="product_name" name="product_name" class="form-control form-control-plaintext my-4" placeholder="Nome do produto " required />
          <input type="number" id="quantity" name="quantity" class="form-control form-control-plaintext my-4" placeholder="Quantidade" required />     
          <input type="number" id="price" name="price" class="form-control form-control-plaintext my-4" placeholder="Preço" required />
          
          <label for="size" class="d-block mt-5">Tamanho:</label>
          <select name="size" id="size" class="form-control form-control-plaintext w-auto mt-2 mb-5" placeholder="Tamanho">
          ...
          <select name="complement" id="complement" class="form-control form-control-plaintext w-auto mt-2 mb-5" placeholder="Complemento">
            <option value="">Selecione</option>
          ...
          <textarea name="description" id="description" cols="30" rows="3" class="form-control form-control-plaintext mb-3 my-4" placeholder="Descrição"></textarea>
          <div class="justify-content-between hoverCoffee">
            <button class="btn btn-secondary my-1 px-5 rounded-lg w-100" onclick="exibirAlertaProduto()">Registrar</button>
          </div>
    ...
    <script src="js/alertCadProd.js"></script>
